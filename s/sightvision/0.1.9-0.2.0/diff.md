# Comparing `tmp/sightvision-0.1.9.tar.gz` & `tmp/sightvision-0.2.0.tar.gz`
...
### Comparing `sightvision-0.1.9/sightvision/PoseModule.py` & `sightvision-0.2.0/sightvision/PoseModule.py`
