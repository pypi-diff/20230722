# Comparing `tmp/Vpro-0.26.tar.gz` & `tmp/Vpro-0.27.tar.gz`
...
## Comparing `Vpro-0.26.tar` & `Vpro-0.27.tar`
...
### Comparing `Vpro-0.26/Vpro/__init__.py` & `Vpro-0.27/Vpro/__init__.py`
...
### Comparing `Vpro-0.26/setup.py` & `Vpro-0.27/setup.py`
