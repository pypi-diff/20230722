# Comparing `tmp/demogpt-1.1.1.4.tar.gz` & `tmp/demogpt-1.1.1.5.tar.gz`
...
### Comparing `demogpt-1.1.1.4/src/alpha/agent_prompts.py` & `demogpt-1.1.1.5/src/alpha/agent_prompts.py`
