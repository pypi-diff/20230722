# Comparing `tmp/odooless-0.1.3.tar.gz` & `tmp/odooless-0.1.4.tar.gz`
...
## Comparing `odooless-0.1.3.tar` & `odooless-0.1.4.tar`
...
### Comparing `odooless-0.1.3/PKG-INFO` & `odooless-0.1.4/PKG-INFO`
...
### Comparing `odooless-0.1.3/README.md` & `odooless-0.1.4/README.md`
...
### Comparing `odooless-0.1.3/odooless/models.py` & `odooless-0.1.4/odooless/models.py`

 * *Files identical despite different names*

### Comparing `odooless-0.1.3/odooless.egg-info/PKG-INFO` & `odooless-0.1.4/odooless.egg-info/PKG-INFO`
...
### Comparing `odooless-0.1.3/setup.py` & `odooless-0.1.4/setup.py`
